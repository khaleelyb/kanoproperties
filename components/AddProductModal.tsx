            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                 ...
                 {/* Hidden Inputs for adding more when in form mode - reuse refs but these are backup in case mode switching fails to mount the others? No, only one set active at a time */}
